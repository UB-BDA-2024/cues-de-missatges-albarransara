...
def test_post_sensor_data_dia_2():
    response = client.post("/sensors/1/data", json={"temperature": 15.0, "humidity": 1.0, "battery_level": 1.0,
                                                    "last_seen": "2020-01-02T00:00:00.000Z"})
    assert response.status_code == 200


def test_post_sensor_data_dia_3():
    response = client.post("/sensors/1/data", json={"temperature": 18.0, "humidity": 1.0, "battery_level": 0.9,
                                                    "last_seen": "2020-01-03T00:00:00.000Z"})
    assert response.status_code == 200


def test_post_sensor_data_veolicitat_hora_1():
    response = client.post("/sensors/2/data",
                           json={"velocity": 1.0, "battery_level": 1.0, "last_seen": "2020-01-01T00:00:00.000Z"})
    assert response.status_code == 200


def test_post_sensor_data_veolicitat_hora_2():
    response = client.post("/sensors/2/data",
                           json={"velocity": 15.0, "battery_level": 1.0, "last_seen": "2020-01-01T01:00:00.000Z"})
    assert response.status_code == 200


def test_post_sensor_data_veolicitat_hora_3():
    response = client.post("/sensors/2/data",
                           json={"velocity": 18.0, "battery_level": 0.9, "last_seen": "2020-01-01T02:00:00.000Z"})
    assert response.status_code == 200
...
def test_post_sensor_data_veolicitat_week_2():
    response = client.post("/sensors/3/data",
                           json={"velocity": 15.0, "battery_level": 1.0, "last_seen": "2020-01-08T00:00:00.000Z"})
    assert response.status_code == 200


def test_post_sensor_data_veolicitat_week_3():
    response = client.post("/sensors/3/data",
                           json={"velocity": 18.0, "battery_level": 0.9, "last_seen": "2020-01-15T00:00:00.000Z"})
    assert response.status_code == 200
